...
export const button: Component = {
  base: {
    ".btn":
      "inline-flex flex-wrap items-center justify-center text-center cursor-pointer select-none transition duration-200 ease-in-out shrink-0 font-semibold py-2 px-4 rounded-field disabled:opacity-80 disabled:pointer-events-none focus:outline-hidden focus:ring-2 hover:no-underline border-0",
  },
  modifier: {
  ...
  state: {
    ".btn-ghost.btn-light": "text-gray-900",
    ...eachColor(({ name, palette, contrast }, s) => ({
