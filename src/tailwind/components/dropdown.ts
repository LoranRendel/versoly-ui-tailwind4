...
export const dropdown: Styles = {
  ...
  ".dropdown-menu":
    "absolute hidden transition duration-200 opacity-0 w-max py-2 bg-white border border-gray-300 rounded-sm mt-2 min-w-[160px] z-1",
